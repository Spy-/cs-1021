...
public class Cell extends Rectangle {
     ...
     */
    void setNeighborAboveCenter(Cell neighborAboveCenter) {
     ...
     */
    void setNeighborAboveRight(Cell neighborAboveRight) {
     ...
     */
    void setNeighborAboveLeft(Cell neighborAboveLeft) {
     ...
     */
    void setNeighborMiddleRight(Cell neighborMiddleRight) {
     ...
     */
    void setNeighborMiddleLeft(Cell neighborMiddleLeft) {
     ...
     */
    void setNeighborBelowCenter(Cell neighborBelowCenter) {
     ...
     */
    void setNeighborBelowRight(Cell neighborBelowRight) {
     ...
     */
    void setNeighborBelowLeft(Cell neighborBelowLeft) {
